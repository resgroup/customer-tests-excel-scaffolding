...
".\packages\customertestsexcel\2.0.2\tools\GenerateCodeFromExcelTest\GenerateCodeFromExcelTest.exe" /folder ".\SampleTests" /namespace SampleTests /usings "SampleSystemUnderTest SampleSystemUnderTest.AnovaCalculator SampleSystemUnderTest.Routing SampleSystemUnderTest.VermeulenNearWakeLength SampleSystemUnderTest.Calculator SampleSystemUnderTest.CustomProperties SampleSystemUnderTest.Misc" /assertionClassPrefix "I" /assembliesUnderTest "C:\projects\customer-tests-excel-scaffolding\SampleSystemUnderTest\obj\Release\SampleSystemUnderTest.dll"