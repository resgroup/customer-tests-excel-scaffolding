...
{
    // A class with the name TurbineGeometry was found in the Excel tests, but
    ...
    // If the custom class filename is 'SpecificationSpecificTurbineGeometryOverride.cs',
    // then it will be used instead of this function. If it is called something else,
    // say 'SpecificationSpecificTurbineGeometryPartial.cs', then this class will remain, and
    ...
    {
        public Double NumberOfBlades { get; private set; }
        ...
        internal SpecificationSpecificTurbineGeometry NumberOfBlades_of(Double numberOfBlades)
        {
