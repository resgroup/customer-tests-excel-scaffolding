...
{
    // A class with the name Cargo was found in the Excel tests, but
    ...
    // If the custom class filename is 'SpecificationSpecificCargoOverride.cs',
    // then it will be used instead of this function. If it is called something else,
    // say 'SpecificationSpecificCargoPartial.cs', then this class will remain, and
    ...
    public partial class SpecificationSpecificCargo : ReportsSpecificationSetup
    {
        ...
        readonly List<SpecificationSpecificItineraryLeg> itineraryLegs;

        public SpecificationSpecificCargo()
        {
            itineraryLegs = new List<SpecificationSpecificItineraryLeg>();
        }
