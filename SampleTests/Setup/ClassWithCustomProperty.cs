...
{
    // A class with the name ClassWithCustomProperty was found in the Excel tests, but
    ...
    // If the custom class filename is 'SpecificationSpecificClassWithCustomPropertyOverride.cs',
    // then it will be used instead of this function. If it is called something else,
    // say 'SpecificationSpecificClassWithCustomPropertyPartial.cs', then this class will remain, and
    ...
    {
        public Double CustomInt { get; private set; }
        ...
        internal SpecificationSpecificClassWithCustomProperty CustomInt_of(Double customInt)
        {
