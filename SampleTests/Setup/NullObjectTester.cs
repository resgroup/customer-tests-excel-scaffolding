...
namespace SampleTests.Setup
{
    ...
    // If the custom class filename is 'SpecificationSpecificNullObjectTesterOverride.cs',
    // then it will be used instead of this function. If it is called something else,
    // say 'SpecificationSpecificNullObjectTesterPartial.cs', then this class will remain, and
