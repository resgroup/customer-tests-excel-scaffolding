...
{
    // A class with the name HasObjectProperty was found in the Excel tests, but
    ...
    // If the custom class filename is 'SpecificationSpecificHasObjectPropertyOverride.cs',
    // then it will be used instead of this function. If it is called something else,
    // say 'SpecificationSpecificHasObjectPropertyPartial.cs', then this class will remain, and
    ...
    public partial class SpecificationSpecificHasObjectProperty : ReportsSpecificationSetup
    {
        ...
        internal SpecificationSpecificHasObjectProperty Anything_of(Object anything)
        {
