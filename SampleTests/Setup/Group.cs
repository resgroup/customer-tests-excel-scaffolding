...
{
    // A class with the name Group was found in the Excel tests, but
    ...
    // If the custom class filename is 'SpecificationSpecificGroupOverride.cs',
    // then it will be used instead of this function. If it is called something else,
    // say 'SpecificationSpecificGroupPartial.cs', then this class will remain, and
    ...
    public partial class SpecificationSpecificGroup : ReportsSpecificationSetup
    {
        ...
        readonly List<SpecificationSpecificFloat> floatss;

        public SpecificationSpecificGroup()
        {
            floatss = new List<SpecificationSpecificFloat>();
        }
